...
// Keep the standalone asset isolation policy identical behind Nginx and locally.
cpSync(resolve('scripts', 'standalone-server.mjs'), standaloneEntry);
...
if (
  checksumFile !== `${wasmChecksum}  fixedcoin_wallet_crypto_web.wasm` ||
