...
const SERVER_URL = 'wss://electrumx.fixedcoin.org:50004';
...
const ADDRESSES: SingleKeyAddress[] = [
  {
    scriptType: 'p2pkh',
    address: 'b1sYGBu5FKdxkL5FCSeJygmkchViYCqAq',
  ...
  },
  {
    ...
    address: '1JEKB1HSaTB8d2fr528v3URQVm5ajMZviw',
    publicKeyHex: PUBLIC_KEY,
    publicKeyCompressed: true,
  ...
  {
    scriptType: 'p2wpkh',
    address: 'fix1qw508d6qejxtdg4y5r3zarvary0c5xw7k7dgkay',
    publicKeyHex: PUBLIC_KEY,
    publicKeyCompressed: true,
