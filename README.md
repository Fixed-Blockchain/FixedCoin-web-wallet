...
FixedCoin Web Wallet is a self-custodial browser wallet for transparent FIX transactions. Wallet secrets are handled locally and are never sent to an application server.

[Open the wallet](https://web.wallet.fixedcoin.org/) · [Self-hosting guide](deploy/README.md)
...
```bash
git clone https://github.com/Fixed-Blockchain/FixedCoin-web-wallet.git
cd FixedCoin-web-wallet
...
- [FixedCoin network and recovery compatibility](docs/FIXEDCOIN.md)
